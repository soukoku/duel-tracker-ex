  ...
  <div class="min-h-screen p-4 sm:p-6 space-y-6 bg-themed">
    ...
    <header class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <router-link to="/" class="flex items-center gap-3 hover:opacity-75 transition-opacity cursor-pointer">
          <img src="/assets/icons/android-chrome-192x192.png" alt="Duel Tracker Logo"
